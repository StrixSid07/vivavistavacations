      ...
      {loading ? (
        ...
        <div className="text-center mt-16">
          ...
          <p className="text-lg text-blue-100">
            ...
            <br />
            Please select a different holiday category to explore more options!
          </p>
        </div>
      ) : (
        <>
                      ...
                      {deal.prices[0]?.hotel?.tripAdvisorRating ? (
                        <>
                          ...
                          <span className="text-black text-sm font-medium drop-shadow">
                            {deal.prices[0].hotel.tripAdvisorRating.toFixed(1)}{" "}
                            ({deal.prices[0].hotel.tripAdvisorReviews} Reviews)
                          </span>
                        </>
                      ) : (
